...
$wp_customize->add_setting(yatri_get_customizer_id('mid_header_branding_visibility'),
    array(
        'default' => $default['mid_header_branding_visibility'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Switch_Group(
        $wp_customize,
        yatri_get_customizer_id('mid_header_branding_visibility'),
        array(
