...
$wp_customize->add_setting(yatri_get_customizer_id('top_header_offcanvas_visibility'),
    array(
        'default' => $default['top_header_offcanvas_visibility'],
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Switch_Group(
        $wp_customize,
        yatri_get_customizer_id('top_header_offcanvas_visibility'),
        array(
