...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Heading(
        ...
        'yatri-heading-global-sidebar',
        array(
            'label' => esc_html__('Global Sidebar', 'yatri'),
            'section' => 'yatri_theme_base_layouts',
            'priority' => 60,
...
$wp_customize->add_setting(yatri_get_customizer_id('global_sidebar'),
    array(
        'default' => $default['global_sidebar'],
        'sanitize_callback' => 'yatri_sanitize_select',
    )
);

$wp_customize->add_control(yatri_get_customizer_id('global_sidebar'),
    array(
        'label' => esc_html__('Global Sidebar', 'yatri'),
        'description' => esc_html__('Global sidebars', 'yatri'),
        'section' => 'yatri_theme_base_layouts',
        'type' => 'select',
        'priority' => 70,
        'choices' => yatri_sidebar_styles()
    )
);
// Setting sidebar width.

$wp_customize->add_setting(yatri_get_customizer_id('sidebar_width'),
    array(
...
$wp_customize->add_control(
    new Mantrabrain_Theme_Customizer_Control_Slider(
        $wp_customize,
        yatri_get_customizer_id('sidebar_width'),
        array(
            'label' => esc_html__('Sidebar Width', 'yatri'),
            'description' => esc_html__('Sidebar width ( in % ). This option will apply only if there is one sidebar(left or right).', 'yatri'),
            'section' => 'yatri_theme_base_layouts',
            'priority' => 80,
            'input_attrs' => array(
                'min' => 20,
            ...
            'active_callback' => 'yatri_is_not_both_sidebar',
