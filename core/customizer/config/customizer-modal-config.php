	...
	$fields['yatri_button_style_design'] = array(
		...
		'yatri_button_style_design_color_fields' => array(
			array(
				...
				'description' => '',
				'default' => '#c1c1c1',
				'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap),.button, input[type="submit"], .yatri-button, .yatri-button span ,.yatri-button .yatri-button-icon',
			...
			array(
				...
				'description' => '',
				'default' => '#c1c1c1',
				'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap):hover,.button:hover, input[type="submit"]:hover, .yatri-button:hover, .yatri-button:hover span, .yatri-button:hover .yatri-button-icon',
				'css_property' => 'color:{{value}};'
			),
			array(
				...
				'description' => '',
				'default' => '#c1c1c1',
				'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap),.button, input[type="submit"], .yatri-button',
				'css_property' => 'background-color:{{value}};'
			),
			array(
				...
				'description' => '',
				'default' => '#c1c1c1',
				'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap):hover,.button:hover, input[type="submit"]:hover, .yatri-button:hover',
				'css_property' => 'background-color:{{value}};'
			),
		),
		'yatri_button_style_design_spacing_fields' =>
			array(
				array(
					...
					'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap),.button, input[type="submit"], .yatri-button,.top-header .yatri-section-button .yatri-button',
				...
				array(
					...
					'selector' => 'button:not(.yatri-offcanvas-close-button):not(.nice-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap),.button, input[type="submit"], .yatri-button, button:not(.nice-button):not(.yatri-offcanvas-close-button):not(.yatri-submenu-toggle):not(.yatri-mobile-navigation-close):not(.yatri-responsive-toggle-menu):not(.search-button):not(.customize-partial-edit-shortcut-button):not(.search-main):not(.yatri-toggle-wrap):hover,.button:hover, input[type="submit"]:hover, .yatri-button:hover,.top-header .yatri-section-button .yatri-button',
				)
			),
