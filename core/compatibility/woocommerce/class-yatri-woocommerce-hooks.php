...
class Yatri_WooCommerce_Hooks
{
    ...
    static function breadcrumb()
    {
        woocommerce_breadcrumb(
            array(
                'wrap_before' => '<nav role="navigation yatri-woo-breadcrumb-nav" aria-label="' . esc_html__('Breadcrumbs', 'zakra') . '" class="breadcrumb-trail breadcrumbs"><ul class="trail-items">',
                'wrap_after' => '</ul></nav>',
