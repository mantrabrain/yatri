<?php
if (!class_exists('Mantrabrain_Theme_Widget_Base')) {

    abstract class Mantrabrain_Theme_Widget_Base extends WP_Widget
    {
        /*
         * @var object Mantrabrain_Theme_Widget_Validation
         */
        public $validation;
        ...
        public function __construct($id_base, $name, $widget_options = array(), $control_options = array())
        {
            ...
            $this->validation = Mantrabrain_Theme_Widget_Validation::instance();
        }
            ...
            switch ($field['type']) {
                ...
                case "dropdown_categories":
                    ...
                    $cat_default_args = array(
                        ...
                        'show_option_all' => esc_html__('All Categories', 'yatri'),
                        'echo' => false,
                        'multiple' => false
                    ...
                    <p>
                        ...
                        if (taxonomy_exists($taxonomy)) {
                            ...
                            echo '<h4>' . sprintf(esc_html__('Taxonomy (%s) not found', 'yatri'), $taxonomy) . '</h4>';
                        }
                ...
                <div class="media-uploader" id="<?php echo $this->get_field_id('background_image'); ?>">
                    <div class="custom_media_preview" style="position:relative;">
                        ...
                        <button class="media_upload button"
                                ...
                                data-choose="<?php esc_attr_e('Choose an image', 'yatri'); ?>"
                                data-update="<?php esc_attr_e('Use image', 'yatri'); ?>"
                                style="width:100%;margin-top:6px;margin-right:30px;"><?php esc_html_e('Select an Image', 'yatri'); ?></button>
                    </div>
