...
```html
<link rel="stylesheet" href="/node_core/modules/owl.carousel/dist/assets/owl.carousel.min.css" />
```
...
```html
<script src="/node_core/modules/jquery/dist/jquery.js"></script>
<script src="/node_core/modules/owl.carousel/dist/owl.carousel.min.js"></script>
```
